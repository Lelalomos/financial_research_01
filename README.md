...
2. **Comprehensive Testing**
   ...
   - 67+ unit tests ensure code quality and correctness
...
python scripts/run_all.py --model-type crnn_attention --epochs 100
...
# 2. Train model
python scripts/train.py --model-type crnn_attention --epochs 100
...
│   │   ├── crnn_attention.py # CNN + BiLSTM + Attention
...
Input (batch, seq_len, features)
    ↓
Embedding Layer (stock, group, day, month)
    ↓
...
| **CRNN + Attention** | CNN + BiLSTM + Attention | **Recommended** |
| **Transformer** | Transformer encoder | Alternative |
